 ...
 * @author admin
 */
public class Visualizador_Banco_de_Dados extends javax.swing.JPanel {
         
    Home Home;
    int id_usuario = 0;
    Usuarios_Do_Sistema_02_Cadastrar_Visualizar Usuarios_Do_Sistema_02_Cadastrar_Visualizar = null;
    ...
    int                  int_UsuarioImagens_Lista = 0;
    int                  qtdArquivos = 0;
    int                  id_imagem = 0;
    //////////////////////////////
     ...
     * @param Home2
     * @param id_usuario2
     * @param Usuarios_Do_Sistema_02_Cadastrar_Visualizar2
     * @param status_cadastro2
     */
    public Visualizador_Banco_de_Dados( Home Home2, int id_usuario2, 
            Usuarios_Do_Sistema_02_Cadastrar_Visualizar Usuarios_Do_Sistema_02_Cadastrar_Visualizar2, String status_cadastro2 ){
        initComponents();
        
        Home = Home2;        
        id_usuario = id_usuario2;
        status_cadastro = status_cadastro2;
        Usuarios_Do_Sistema_02_Cadastrar_Visualizar = Usuarios_Do_Sistema_02_Cadastrar_Visualizar2;
    ...
    new Thread() {   @Override public void run() { try { 
	    ...
	    BufferedImage bufImg = null;
            ...
            try{
                ...
                bufImg = ImageIO.read(new ByteArrayInputStream( UsuarioImagens.get(int_UsuarioImagens_Lista).getImagem() )); //ImageIO.read( img );
	    ...
	    try{
                ...
                ///////////////////////////////////////////
                id_imagem = UsuarioImagens.get(int_UsuarioImagens_Lista).getId();
                qtdArquivos = UsuarioImagens.size();
                System.out.println("qtdArquivos: " + qtdArquivos);
                System.out.println("int_UsuarioImagens_Lista: " + int_UsuarioImagens_Lista);
    ...
    private void initComponents() {
        ...
        lbEsquerdo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/visualizador_imagens/imagens/laranja_anterior.png"))); // NOI18N
        ...
        lbDireito.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/visualizador_imagens/imagens/laranja_proximo.png"))); // NOI18N
        ...
        lbHome.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/visualizador_imagens/imagens/laranja_home.png"))); // NOI18N
        ...
        lbExcluir.setIcon(new javax.swing.ImageIcon("C:\\000000\\JM\\00_Generico\\004_Generico_JM_Projeto_Usuario_Imagens\\Generico_JM_004_Usuarios_Imagens\\Menus_Norte\\home_controle_menus_norte\\imagens\\exluir.png")); // NOI18N
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lbEsquerdo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel7, jLabel8, lbDireito, lbEsquerdo, lbHome, pesquisarImagem});
    ...
    private void setarImagem_da_Lista(){ 
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
                ...
                if( (int_UsuarioImagens_Lista < qtdArquivos) && (int_UsuarioImagens_Lista >= 0) ){
	            ...
	            try{
                        ...
                        System.out.println("setarImagem_da_Lista 1 - int_UsuarioImagens_Lista: " + int_UsuarioImagens_Lista);
                        
                    }catch(Exception ex){}
                }
                else{   
                    
                    if( int_UsuarioImagens_Lista <= 0){
                        int qtd_Arquivos_da_Pasta = qtdArquivos-1;
                        int_UsuarioImagens_Lista = qtd_Arquivos_da_Pasta;
                    }
                    else{
                        int_UsuarioImagens_Lista = 0;
                    }
                    ...
                    try {  
                        ...
                        System.out.println("setarImagem_da_Lista 2 - int_UsuarioImagens_Lista: " + int_UsuarioImagens_Lista);
                    }catch(Exception ex){}
                }
            ...
            if( lbExcluir.isEnabled() ){
                try{
                    ...
                    Exportando.pbg.setValue( 50 );                    
                     ...
                     List<UsuarioImagens> UsuarioImagens_Excluir = null;
                    try{ 
                        Query q = JPAUtil.em().createNativeQuery("SELECT * FROM JM.USUARIO_IMAGENS WHERE ID_USUARIO_SISTEMA = ? AND ID = ?", UsuarioImagens.class );
                        q.setParameter( 1, id_usuario );
                        q.setParameter( 2, id_imagem );
                        
                        UsuarioImagens_Excluir = q.getResultList();   
                    }catch( Exception e ){ }
        
                    String rbusca = ""; 
                    try{ rbusca = UsuarioImagens_Excluir.get(0).getNome(); }catch( Exception e ){}
            
                    if( !rbusca.equals("") ){
            
                        DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( UsuarioImagens_Excluir.get(0), JPAUtil.em());
        ...
        if( btSalvar.isEnabled() ){
            ...
            new Thread() {   @Override public void run() { try { 
                ...
                if(status_cadastro.equalsIgnoreCase("Cadastrando...")){
                    ...
                    Usuarios_Do_Sistema_02_Cadastrar_Visualizar.lista_de_Endereco_imagemExterna_.add( imagemExterna_Endereco.getPath() );
    ...
    private void salvar(){ 
        ...
        try { 
            ...
            try{
                ...
                try{ UsuarioImagens.setIdUsuarioSistema( id_usuario ); }catch( Exception e ){}
                ...
                try{
                    ...
                    try{ 
                        ...
                        List<UsuarioImagens> lista_Banco = q.getResultList();   
                        ///////////////////////////////////
                        id_imagem = UsuarioImagens_Cadastrado.getId();
                        qtdArquivos = lista_Banco.size();
                        System.out.println("atual - qtdArquivos: " + qtdArquivos);
                        System.out.println("atual - int_UsuarioImagens_Lista: " + int_UsuarioImagens_Lista);
