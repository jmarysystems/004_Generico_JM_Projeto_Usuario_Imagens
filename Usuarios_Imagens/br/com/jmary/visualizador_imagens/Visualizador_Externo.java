 ...
 * @author admin
 */
public class Visualizador_Externo extends javax.swing.JPanel {
     ...
     * @param altura2
     */
    public Visualizador_Externo( Home Home2, int img_Atual2, String endereco_Externo_da_Pasta2, int largura2, int altura2 ) {
        initComponents();
    ...
    private void jLabel5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Visualizador Imagem Externa", "/imagens_internas/livroTp.gif", 
                    new Visualizador_Externo(Home,img_Atual,endereco_Externo_da_Pasta,largura,altura) );
