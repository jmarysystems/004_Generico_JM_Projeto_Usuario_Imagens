 ...
 * @author ana
 */
public class Menu_1_JM_Usuarios_Imagens extends javax.swing.JPanel {

    Home Home;
    Controle_de_Alterar_Menu_Norte Controle_de_Alterar_Menu_Norte;
        
    public Menu_1_JM_Usuarios_Imagens( Home Home2, Controle_de_Alterar_Menu_Norte Controle_de_Alterar_Menu_Norte2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios5.setText("Usuários Imagens");
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Usuários Imagens Índice", "livroTp.gif", new Visualizador_Indice(Home) ); 
