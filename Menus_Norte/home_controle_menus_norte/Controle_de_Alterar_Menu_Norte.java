...
import home_controle_menus_norte.menu_01_jm_Usuarios_Imagens.Menu_1_JM;
import home_controle_menus_norte.menu_01_jm_Usuarios_Imagens.Menu_1_JM_Usuarios_Imagens;
...
public class Controle_de_Alterar_Menu_Norte {
    ...
    private void inicio() {
        try{
            ...
            adicionarSubmenu(new Menu_1_JM_Usuarios_Imagens( Home, this ) );
