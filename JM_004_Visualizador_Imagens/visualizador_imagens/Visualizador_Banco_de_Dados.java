...
public class Visualizador_Banco_de_Dados extends javax.swing.JPanel {
     ...
     */
    public Visualizador_Banco_de_Dados( Home Home2, int id_usuario2, String status_cadastro2, 
        ...
        if( btSalvar.isEnabled() ){
            ...
            new Thread() {   @Override public void run() { try { 
                ...
                if(status_cadastro.equalsIgnoreCase("Cadastrando...")){
                    ...
                    try{ Usuarios_Do_Sistema_02_Cadastrar_Visualizar.lista_de_Endereco_imagemExterna_.add( imagemExterna_Endereco.getPath() ); } catch( Exception e ){} 
                    try{ 
                        
                        File img = new File( imagemExterna_Endereco.getPath() );
                        Usuarios_Do_Sistema_02_Cadastrar_Visualizar.setarImagemExterna_Endereco_for( img ); 
                    } catch( Exception e ){}
