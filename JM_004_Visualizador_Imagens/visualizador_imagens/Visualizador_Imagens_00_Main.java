...
import visualizador_imagens_menu_e_submenu.Visualizador_Imagens_Menu_01;
 ...
 * @author Ana
 */
public class Visualizador_Imagens_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Visualizador_Imagens_Menu_01( Home ).Barra_Menu );
        Home.adicionar_SubMenu( new Visualizador_Imagens_Submenu_01( Home ) );
        Home.adicionar_Tela_De_Trabalho( "Visualizador de Imagens Índice", new Visualizador_Indice(Home) );
    }
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Visualizador_Imagens_00_Main();
        applet.init();
