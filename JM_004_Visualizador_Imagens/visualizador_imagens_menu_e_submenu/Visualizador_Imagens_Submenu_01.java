...
package visualizador_imagens_menu_e_submenu;

import br.com.jmary.home.Home;
import visualizador_imagens.Visualizador_Indice;

/**
 *
 * @author ana
 */
public class Visualizador_Imagens_Submenu_01 extends javax.swing.JPanel {

    Home Home;
        
    public Visualizador_Imagens_Submenu_01( Home Home2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios5.setText("Visualizador de Imagens");
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Visualizador de Imagens Índice", "livroTp.gif", new Visualizador_Indice(Home) ); 
